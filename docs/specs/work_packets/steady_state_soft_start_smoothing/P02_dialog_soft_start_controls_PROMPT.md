# P02 Dialog Soft-Start Controls Prompt
...
Implement exactly `P02` on branch `codex/steady_state_soft_start_smoothing/p02-dialog-soft-start-controls`.
...
Create `docs/specs/work_packets/steady_state_soft_start_smoothing/P02_dialog_soft_start_controls_WRAPUP.md` with sections:
